...
function EditAndDeleteDropDown(_a) {
    var setDeleteDropDownId = _a.setDeleteDropDownId, handleChangeResumeName = _a.handleChangeResumeName, handleDeleteResume = _a.handleDeleteResume;
    ...
    return (React.createElement("div", { className: cx("container"), ref: ref },
        ...
        React.createElement(core_1.UnstyledButton, { className: cx("menu"), onClick: handleDeleteResume }, "\uC774\uB825\uC11C\uC0AD\uC81C")));
}
exports["default"] = EditAndDeleteDropDown;
